...
const emptyState: BrowserState = { tabs: [], tabGroups: {}, activeTabId: "", bookmarks: [], bookmarkFolders: [], history: [], downloads: [], shortcuts: [], topSites: [], preferences: { searchEngine: "duckduckgo", startupBehavior: "continue", downloadLocation: "", askWhereToSave: false, appearance: "system", newTabShowShortcuts: true, newTabShowTopSites: true, newTabBackground: "" }, permissions: {}, pendingPermissions: [], effectiveTheme: "light" };
    ...
    <main className={`browser-shell theme-${browserState.effectiveTheme || "light"}`}>
      ...
      <section className="browser-surface" ref={browserSurfaceRef} aria-label="Browser content">
        ...
        /> : isSettingsVisible && browserState.preferences ? <SettingsPanel
          ...
          onClose={closeLibrary}
        /> : activeTab?.isNewTab && <NewTabPage key={activeTab.id} onNavigate={submitAddress} topSites={browserState.topSites} shortcuts={browserState.shortcuts} preferences={browserState.preferences} />}
      </section>
