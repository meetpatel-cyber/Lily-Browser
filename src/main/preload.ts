...
contextBridge.exposeInMainWorld("lilyBrowser", {
  ...
  updateBookmark: (id: string, url: string, title: string, folderId?: string) => ipcRenderer.invoke("browser:update-bookmark", id, url, title, folderId),
  addShortcut: (url: string, title: string) => ipcRenderer.invoke("browser:add-shortcut", url, title),
  updateShortcut: (id: string, url: string, title: string) => ipcRenderer.invoke("browser:update-shortcut", id, url, title),
  removeShortcut: (id: string) => ipcRenderer.invoke("browser:remove-shortcut", id),
  createBookmarkFolder: (name: string) => ipcRenderer.invoke("browser:create-bookmark-folder", name),
  renameBookmarkFolder: (id: string, name: string) => ipcRenderer.invoke("browser:rename-bookmark-folder", id, name),
  deleteBookmarkFolder: (id: string) => ipcRenderer.invoke("browser:delete-bookmark-folder", id),
  ...
  chooseNewTabBackground: (): Promise<void> => ipcRenderer.invoke("browser:choose-new-tab-background"),
